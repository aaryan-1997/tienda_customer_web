    ...
    child: InkWell(
      onTap: ()async{
        ...
        if(_formKey.currentState!.validate()){
          Provider.of<AuthProvider>(context,listen: false).signUp(context: context, data: {
            ...
            Navigator.push(context, MaterialPageRoute(builder: (context)=>OTPScreen(mobile: _mobileController.text,),),);
      ...
      child:(isLoad==true)?CustomLoader():  Container(
      ...
      text: TextSpan(
          ...
          children: [
            TextSpan(
              text: 'Login',
              style: TextStyle(
                  color: appColor, fontWeight: FontWeight.bold, decoration: TextDecoration.underline),
